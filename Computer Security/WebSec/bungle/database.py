...
def connect():
    ...
    return mdb.connect(host='localhost', user='skaus3', password='423510c156a3f2680ee62f3fff42ca1c05fa87b05551f18fa5130b5dfe1017cc', db='project2')
...
def createUser(username, password):
    ...
    cur.execute("INSERT INTO users (username, password, passwordhash) VALUES (%s, %s, %s)", (username, password, password_hash))
    db_rw.commit()
