...
sus_keywords = ["DPI", '`(?!include "instr_cg.svh"$)', "verilator", "xprop_off", "translate_off", "dc_tcl_script_begin", "dc_script_begin"]
banned_wholewords = []
search_dir = ["hvl/vcs/randinst.svh", "hvl/vcs/instr_cg.svh", "pkg"]
